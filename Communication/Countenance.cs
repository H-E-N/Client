...
{
    public partial class Countenance :CCSkinMain
    {
            ...
            try
            {
                ...
                try
                {
                    if (!File.Exists(Path.Combine(Application.StartupPath, this.ImagePath + "Images.db")))
                    {
                        ...
                        try
                        {
                            Base.BinarySerializer(this.Images, Path.Combine(Application.StartupPath, this.ImagePath + "Images.db"));
                        }
                        catch (Exception ex)
                        {
                            Trace.WriteLine(ex);
                    ...
                    else
                    {
                        ...
                        this.Images = Base.BinaryDeserialize<List<ImageEntity>>(Path.Combine(Application.StartupPath, this.ImagePath + "Images.db"));
                        try
                        {
